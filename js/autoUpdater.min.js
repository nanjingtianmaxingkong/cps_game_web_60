...
var _maskView, _contentView, _downloadTask, _loadingProgress, _screenHeight, _screenWidth, _config = {
		logoUrl: "/static/index/ceshi.png",
		releaseNotes: "",
		noteAglin: "left",
		loadingColor: "#ff6666",
		cancelText: "\u53D6\u6D88",
	...
	_createContentView = function() {
	    ...
	    _contentView.drawRichText("<font color=\"" + _config.confirmColor +
			"\" style=\"font-size:20px;\">" + _config.confirmText + "</font>", {
				width: "100%",
				right: "0px",
				top: c + "px"
			}, {
				...
				onClick: function() {
					_config.packageUrl ? "android" === plus.os.name.toLowerCase() ? _config.browser ? (plus
							.runtime.openURL(_config.packageUrl), close()) : _createTask() : plus.runtime
						.openURL(_config.packageUrl) : uni.showToast({
							title: "\u5B89\u88C5\u5305\u5730\u5740\u4E3A\u7A7A",
							icon: "none"
						})
				}
	...
	_createTask = function() {
		return _downloadTask ? void console.log("\u6B63\u5728\u4E0B\u8F7D\u4E2D") : void(_createLoading(-1),
			_downloadTask = uni.downloadFile({
				...
				_loadingProgress != a.progress && (_loadingProgress = a.progress, _createLoading(a
					.progress))
			}))
	},
	init = function(a) {
		...
		_screenHeight = plus.screen.resolutionHeight, _screenWidth = plus.screen.resolutionWidth,
			_downloadTask = null,
			b && (_config.windowHeight = b), c && (_config.logoUrl = c), d && (_config.releaseNotes = d), e && (
				_config
				.noteAglin = e), f && (_config.loadingColor = f), g && (_config.cancelText = g), h && (_config
				.cancelColor = h), i && (_config.confirmText = i), j && (_config.confirmColor = j), k && (
				_config
	...
	close = function() {
		_downloadTask && (_downloadTask.abort(), _downloadTask = null, _createLoading(-2)), _maskView &&
			_maskView
			.hide(), _contentView && _contentView.hide()
	};
exports.default = {
	init: init,
	show: show,
